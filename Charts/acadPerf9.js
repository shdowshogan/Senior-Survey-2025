document.addEventListener("DOMContentLoaded", function () {
    ...
    const chartData = {
        'Aerospace Engineering': [13, 2, 0, 2, 0, 2],
        'Biosciences and Bioengineering': [3, 0, 0, 0, 0, 0],
        'Chemical Engineering': [17, 12, 2, 0, 0, 0],
        'Chemistry': [5, 0, 0, 0, 0, 2],
        'Civil Engineering': [22, 3, 3, 0, 2, 3],
        'Computer Science & Engineering': [20, 7, 5, 0, 0, 0],
